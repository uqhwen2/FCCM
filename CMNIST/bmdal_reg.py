...
#    num_to_select = int(len(idx_remaining_0) * 0.20)
    ...
    for query_step in range(al_step):
        ...
        job_dir_path = Path('saved_models/cmnist_cnn/method_{}/seed_{}/step_{}'.format(config.get("acquisition_function"), seed, 0))
...
#        surragate = DeepKernelGP_(model.encoder, model.gp)
        ...
        job_dir_path = Path('saved_models/cmnist_dnn/method_{}/seed_{}/step_{}'.format(config.get("acquisition_function"), seed, 0))
