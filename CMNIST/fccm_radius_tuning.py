...
#                print('Counterfactual covered')
        ...
        print(f"Number of points in control_index covered by idx_sub_training_1 within distance {args.radius}: {round(coverage_10, 2)}")
        ...
        print(f"Number of points in treated_index covered by idx_sub_training_0 within distance {args.radius}: {round(coverage_01, 2)}")

        coverage_list_00.append(coverage_00)
        coverage_list_01.append(coverage_01)

# Specify the file pathstep_1
file_path = 'text_results/coverage_visuals_{}/pehe_fccm_coverage_{}_{}_r{}.csv'.format(args.alpha,
                                                                                            args.alpha,
                                                                                            args.seed,
                                                                                            args.radius)
