...
# for seed in range(num_trial):
    ...
    for query_step in range(al_step):
        ...
        job_dir_path = Path('saved_models/selection_visuals/method_{}/seed_{}/step_{}'.format(
        ...
        while len(acquired_treated) + len(acquired_control) < num_of_samples:
            ...
            if max_value_1.item() >= 0: # max_value_0.item():
...
file_path = 'text_results/qhte/pehe_qhte_{}.csv'.format(args.seed)
