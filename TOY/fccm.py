...
#    G.add_edges_from(edges)
    ...
    threshold_1, threshold_0, threshold_10, threshold_01 = 0.11, 0.11, args.radius, 0.11
...
#    print('Free Up','\n')
    ...
    for query_step in range(al_step):
        ...
        job_dir_path = Path('saved_models/main_results/method_{}_alpha{}_r10_{}/seed_{}/step_{}'.format(
...
file_path = 'text_results/fccm/pehe_fccm_seed{}_alpha{}_r10_{}.csv'.format(
    args.seed, args.alpha, args.radius
)
