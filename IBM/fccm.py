...
if num_trial == 1:
    ...
    print('valid size:', len(T_valid), 'test size:', len(T_test), 'treated size:', len(idx_remaining_1)+len(idx_sub_training_1))
    ...
    threshold_1, threshold_0, threshold_10, threshold_01 = 0.11, 0.11, 0.11, 0.11
...
#    print('Free Up','\n')
    ...
    for query_step in range(al_step):
        ...
        job_dir_path = Path(
            'saved_models/method_{}_{}/seed_{}/step_{}'.format(
                config.get("acquisition_function"), args.alpha, seed, 0)
        )
...
file_path = 'text_results/fccm/pehe_fccm_{}_{}.csv'.format(args.alpha, args.alpha, args.seed)
