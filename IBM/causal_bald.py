...
# for seed in range(num_trial):
    ...
    idx_sub_training = idx_pool[:warm_up] # global index
    idx_remaining = idx_pool[warm_up:] # global index
    ...
    idx_sub_training_1 = idx_sub_training[list_1]  # 20% as initial # global index
    idx_sub_training_0 = idx_sub_training[list_0]  # 10% as initial # global index
    ...
    # Calculate the number of elements to select (25% of idx_remaining_0)
